...
5. **COPIE A CHAVE IMEDIATAMENTE** - ela so sera exibida uma vez!
  - A chave sera uma string longa unica (evite publicar em repositorios)
...
# Sua API Key (cole a chave gerada no Passo 3)
API_KEY = "SUA_CHAVE_AQUI"

# Nome da sessao (exatamente como criou no Passo 2)
SESSION_NAME = "Nome da Sua Sessao"

# URL publica opcional para webhooks (defina por variavel de ambiente)
# Exemplo no PowerShell: $env:PUBLIC_WEBHOOK_URL = "https://seu-subdominio.ngrok-free.app/webhook"
...
5. **COPY THE KEY IMMEDIATELY** - it will only be shown once!
  - The key is a long unique string (do not publish it in repositories)
...
# Your API Key (paste the key generated in Step 3)
API_KEY = "YOUR_API_KEY_HERE"

# Session name (exactly as created in Step 2)
SESSION_NAME = "Your Session Name"

# Optional public webhook URL (set via environment variable)
# PowerShell example: $env:PUBLIC_WEBHOOK_URL = "https://your-subdomain.ngrok-free.app/webhook"
PUBLIC_WEBHOOK_URL = os.getenv("PUBLIC_WEBHOOK_URL", "")
...
5. **COPIE LA CLAVE INMEDIATAMENTE** - solo se mostrara una vez!
  - La clave sera una cadena larga y unica (no la publique en repositorios)
...
# URL publica opcional para webhooks (definala por variable de entorno)
# Ejemplo en PowerShell: $env:PUBLIC_WEBHOOK_URL = "https://su-subdominio.ngrok-free.app/webhook"
PUBLIC_WEBHOOK_URL = os.getenv("PUBLIC_WEBHOOK_URL", "")
